...
class CapsulesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create capsule" do
    assert_difference('Capsule.count') do
      post capsules_url, params: { capsule: { active: @capsule.active, comments: @capsule.comments, date: @capsule.date, name: @capsule.name, reminder_email: @capsule.reminder_email, user_id: @capsule.user_id } }
    end
  ...
  test "should update capsule" do
    patch capsule_url(@capsule), params: { capsule: { active: @capsule.active, comments: @capsule.comments, date: @capsule.date, name: @capsule.name, reminder_email: @capsule.reminder_email, user_id: @capsule.user_id } }
