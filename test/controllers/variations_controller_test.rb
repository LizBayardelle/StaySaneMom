...
class VariationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create variation" do
    assert_difference('Variation.count') do
      post variations_url, params: { variation: { active: @variation.active, description: @variation.description, name: @variation.name, price: @variation.price, product_id: @variation.product_id } }
    end
  ...
  test "should update variation" do
    patch variation_url(@variation), params: { variation: { active: @variation.active, description: @variation.description, name: @variation.name, price: @variation.price, product_id: @variation.product_id } }
