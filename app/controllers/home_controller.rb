class HomeController < ApplicationController
  ...
  def house
    ...
    if params[:tag]
      ...
      @other_blogs = Blog.where(category: "House", published: true).order("published_on DESC").tagged_with(params[:tag]).offset(3).all
    else
      @recent_blogs = Blog.where(category: "House", published: true).order("published_on DESC").limit(3)
      @other_blogs = Blog.where(category: "House", published: true).order("published_on DESC").offset(3).all
    end
  ...
  def spouse
    ...
    if params[:tag]
      ...
      @other_blogs = Blog.where(category: "Spouse", published: true).order("published_on DESC").tagged_with(params[:tag]).offset(3).all
    else
      @recent_blogs = Blog.where(category: "Spouse", published: true).order("published_on DESC").limit(3)
      @other_blogs = Blog.where(category: "Spouse", published: true).order("published_on DESC").offset(3).all
    end
    @tags = Blog.tag_counts_on(:tags)
  end
  ...
  def kids
    ...
    if params[:tag]
      ...
      @other_blogs = Blog.where(category: "Kids", published: true).order("published_on DESC").tagged_with(params[:tag]).offset(3).all
    else
      @recent_blogs = Blog.where(category: "Kids", published: true).order("published_on DESC").limit(3)
      @other_blogs = Blog.where(category: "Kids", published: true).order("published_on DESC").offset(3).all
    end
    @tags = Blog.tag_counts_on(:tags)
  end
  ...
  def self
    ...
    if params[:tag]
      ...
      @other_blogs = Blog.where(category: "Self", published: true).order("published_on DESC").tagged_with(params[:tag]).offset(3).all
    else
      @recent_blogs = Blog.where(category: "Self", published: true).order("published_on DESC").limit(3)
      @other_blogs = Blog.where(category: "Self", published: true).order("published_on DESC").offset(3).all
    end
    @tags = Blog.tag_counts_on(:tags)
  end
end
