class PreauthorizationsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @preauthorization.update(preauthorization_params)
        format.html { redirect_to admin_users_path, notice: 'Preauthorization was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to admin_users_path, notice: 'Preauthorization was successfully destroyed.' }
